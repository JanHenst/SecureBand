...
$router->map( 'GET', '/information', 'InfoController#InfoScpFoundation', 'information' );

$router->map( 'GET', '/game-info', 'GameInfoController#gamepage', 'game-info' );

$router->map( 'GET', '/agenda', 'AgendaController#agendapage', 'agenda' );

$router->map( 'GET', '/form', 'FormController#formpage', 'form' );
